    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['user'], name='follow_user_idx'), models.Index(fields=['author'], name='follow_author_idx')],
                'constraints': [models.UniqueConstraint(fields=('user', 'author'), name='uniq_follow_user_author')],
            },
        ),
    ]
